...
func RefundRequestedBy(v int64) predicate.PaymentOrder {
...
func UserEmailIsNil() predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldIsNull(FieldUserEmail))
}

// UserEmailNotNil applies the NotNil predicate on the "user_email" field.
func UserEmailNotNil() predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldNotNull(FieldUserEmail))
}
...
func UserNameIsNil() predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldIsNull(FieldUserName))
}

// UserNameNotNil applies the NotNil predicate on the "user_name" field.
func UserNameNotNil() predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldNotNull(FieldUserName))
}
...
func PayAmountIsNil() predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldIsNull(FieldPayAmount))
}

// PayAmountNotNil applies the NotNil predicate on the "pay_amount" field.
func PayAmountNotNil() predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldNotNull(FieldPayAmount))
}
...
func FeeRateIsNil() predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldIsNull(FieldFeeRate))
}

// FeeRateNotNil applies the NotNil predicate on the "fee_rate" field.
func FeeRateNotNil() predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldNotNull(FieldFeeRate))
}
...
// PaymentTradeNoIsNil applies the IsNil predicate on the "payment_trade_no" field.
func PaymentTradeNoIsNil() predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldIsNull(FieldPaymentTradeNo))
}

// PaymentTradeNoNotNil applies the NotNil predicate on the "payment_trade_no" field.
func PaymentTradeNoNotNil() predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldNotNull(FieldPaymentTradeNo))
}
...
func RefundAmountIsNil() predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldIsNull(FieldRefundAmount))
}

// RefundAmountNotNil applies the NotNil predicate on the "refund_amount" field.
func RefundAmountNotNil() predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldNotNull(FieldRefundAmount))
}
...
func RefundRequestedByEQ(v int64) predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldEQ(FieldRefundRequestedBy, v))
}

// RefundRequestedByNEQ applies the NEQ predicate on the "refund_requested_by" field.
func RefundRequestedByNEQ(v int64) predicate.PaymentOrder {
...
func RefundRequestedByIn(vs ...int64) predicate.PaymentOrder {
...
func RefundRequestedByNotIn(vs ...int64) predicate.PaymentOrder {
...
func RefundRequestedByGT(v int64) predicate.PaymentOrder {
...
func RefundRequestedByGTE(v int64) predicate.PaymentOrder {
...
func RefundRequestedByLT(v int64) predicate.PaymentOrder {
...
func RefundRequestedByLTE(v int64) predicate.PaymentOrder {
...
func ClientIPIsNil() predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldIsNull(FieldClientIP))
}

// ClientIPNotNil applies the NotNil predicate on the "client_ip" field.
func ClientIPNotNil() predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldNotNull(FieldClientIP))
}
...
// SrcHostIsNil applies the IsNil predicate on the "src_host" field.
func SrcHostIsNil() predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldIsNull(FieldSrcHost))
}

// SrcHostNotNil applies the NotNil predicate on the "src_host" field.
func SrcHostNotNil() predicate.PaymentOrder {
	return predicate.PaymentOrder(sql.FieldNotNull(FieldSrcHost))
}
...
func HasPlanWith(preds ...predicate.SubscriptionPlan) predicate.PaymentOrder {
	return predicate.PaymentOrder(func(s *sql.Selector) {
		step := newPlanStep()
		sqlgraph.HasNeighborsWith(s, step, func(s *sql.Selector) {
			for _, p := range preds {
...
func HasAuditLogs() predicate.PaymentOrder {
	return predicate.PaymentOrder(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
func HasAuditLogsWith(preds ...predicate.PaymentAuditLog) predicate.PaymentOrder {
	return predicate.PaymentOrder(func(s *sql.Selector) {
