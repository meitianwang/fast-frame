...
func (_c *PaymentProviderInstanceCreate) AddOrderIDs(ids ...int64) *PaymentProviderInstanceCreate {
	_c.mutation.AddOrderIDs(ids...)
	return _c
}

// AddOrders adds the "orders" edges to the PaymentOrder entity.
func (_c *PaymentProviderInstanceCreate) AddOrders(v ...*PaymentOrder) *PaymentProviderInstanceCreate {
...
func (u *PaymentProviderInstanceUpsert) ClearLimits() *PaymentProviderInstanceUpsert {
	u.SetNull(paymentproviderinstance.FieldLimits)
	return u
}
...
// ClearLimits clears the value of the "limits" field.
func (u *PaymentProviderInstanceUpsertOne) ClearLimits() *PaymentProviderInstanceUpsertOne {
	return u.Update(func(s *PaymentProviderInstanceUpsert) {
		s.ClearLimits()
	})
}
...
// ClearLimits clears the value of the "limits" field.
func (u *PaymentProviderInstanceUpsertBulk) ClearLimits() *PaymentProviderInstanceUpsertBulk {
	return u.Update(func(s *PaymentProviderInstanceUpsert) {
		s.ClearLimits()
	})
}
