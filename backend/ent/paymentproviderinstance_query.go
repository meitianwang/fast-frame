...
func (_q *PaymentProviderInstanceQuery) QueryOrders() *PaymentOrderQuery {
...
func (_q *PaymentProviderInstanceQuery) WithOrders(opts ...func(*PaymentOrderQuery)) *PaymentProviderInstanceQuery {
	query := (&PaymentOrderClient{config: _q.config}).Query()
...
func (_q *PaymentProviderInstanceQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*PaymentProviderInstance, error) {
	...
	if query := _q.withOrders; query != nil {
		if err := _q.loadOrders(ctx, query, nodes,
			func(n *PaymentProviderInstance) { n.Edges.Orders = []*PaymentOrder{} },
			func(n *PaymentProviderInstance, e *PaymentOrder) { n.Edges.Orders = append(n.Edges.Orders, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *PaymentProviderInstanceQuery) loadOrders(ctx context.Context, query *PaymentOrderQuery, nodes []*PaymentProviderInstance, init func(*PaymentProviderInstance), assign func(*PaymentProviderInstance, *PaymentOrder)) error {
	...
	query.Where(predicate.PaymentOrder(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(paymentproviderinstance.OrdersColumn), fks...))
	}))
