...
func (_q *PaymentChannelQuery) QueryGroup() *GroupQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(paymentchannel.Table, paymentchannel.FieldID, selector),
...
func (_q *PaymentChannelQuery) WithGroup(opts ...func(*GroupQuery)) *PaymentChannelQuery {
	query := (&GroupClient{config: _q.config}).Query()
...
func (_q *PaymentChannelQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*PaymentChannel, error) {
	...
	if query := _q.withGroup; query != nil {
		if err := _q.loadGroup(ctx, query, nodes, nil,
			func(n *PaymentChannel, e *Group) { n.Edges.Group = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *PaymentChannelQuery) loadGroup(ctx context.Context, query *GroupQuery, nodes []*PaymentChannel, init func(*PaymentChannel), assign func(*PaymentChannel, *Group)) error {
	ids := make([]int64, 0, len(nodes))
	nodeids := make(map[int64][]*PaymentChannel)
	for i := range nodes {
...
func (_q *PaymentChannelQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withGroup != nil {
			_spec.Node.AddColumnOnce(paymentchannel.FieldGroupID)
		}
	}
