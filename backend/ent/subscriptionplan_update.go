...
func (_u *SubscriptionPlanUpdate) SetPrice(v decimal.Decimal) *SubscriptionPlanUpdate {
	_u.mutation.SetPrice(v)
	return _u
}

// SetNillablePrice sets the "price" field if the given value is not nil.
func (_u *SubscriptionPlanUpdate) SetNillablePrice(v *decimal.Decimal) *SubscriptionPlanUpdate {
	if v != nil {
		_u.SetPrice(*v)
	}
	return _u
...
func (_u *SubscriptionPlanUpdate) SetOriginalPrice(v decimal.Decimal) *SubscriptionPlanUpdate {
	_u.mutation.SetOriginalPrice(v)
	return _u
}

// SetNillableOriginalPrice sets the "original_price" field if the given value is not nil.
func (_u *SubscriptionPlanUpdate) SetNillableOriginalPrice(v *decimal.Decimal) *SubscriptionPlanUpdate {
	if v != nil {
...
func (_u *SubscriptionPlanUpdate) ClearProductName() *SubscriptionPlanUpdate {
...
func (_u *SubscriptionPlanUpdate) AddOrderIDs(ids ...int64) *SubscriptionPlanUpdate {
	_u.mutation.AddOrderIDs(ids...)
	return _u
}

// AddOrders adds the "orders" edges to the PaymentOrder entity.
func (_u *SubscriptionPlanUpdate) AddOrders(v ...*PaymentOrder) *SubscriptionPlanUpdate {
...
func (_u *SubscriptionPlanUpdate) ClearOrders() *SubscriptionPlanUpdate {
	_u.mutation.ClearOrders()
	return _u
}

// RemoveOrderIDs removes the "orders" edge to PaymentOrder entities by IDs.
func (_u *SubscriptionPlanUpdate) RemoveOrderIDs(ids ...int64) *SubscriptionPlanUpdate {
	_u.mutation.RemoveOrderIDs(ids...)
	return _u
}

// RemoveOrders removes "orders" edges to PaymentOrder entities.
func (_u *SubscriptionPlanUpdate) RemoveOrders(v ...*PaymentOrder) *SubscriptionPlanUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *SubscriptionPlanUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.Price(); ok {
		_spec.SetField(subscriptionplan.FieldPrice, field.TypeOther, value)
	}
	if value, ok := _u.mutation.OriginalPrice(); ok {
		_spec.SetField(subscriptionplan.FieldOriginalPrice, field.TypeOther, value)
	}
	if _u.mutation.OriginalPriceCleared() {
		_spec.ClearField(subscriptionplan.FieldOriginalPrice, field.TypeOther)
	}
	...
	if _u.mutation.FeaturesCleared() {
		_spec.ClearField(subscriptionplan.FieldFeatures, field.TypeString)
	}
	...
	if _u.mutation.ProductNameCleared() {
		_spec.ClearField(subscriptionplan.FieldProductName, field.TypeString)
	}
	...
	if _u.mutation.OrdersCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   subscriptionplan.OrdersTable,
			Columns: []string{subscriptionplan.OrdersColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
// SetPrice sets the "price" field.
func (_u *SubscriptionPlanUpdateOne) SetPrice(v decimal.Decimal) *SubscriptionPlanUpdateOne {
	_u.mutation.SetPrice(v)
	return _u
}

// SetNillablePrice sets the "price" field if the given value is not nil.
func (_u *SubscriptionPlanUpdateOne) SetNillablePrice(v *decimal.Decimal) *SubscriptionPlanUpdateOne {
	if v != nil {
		_u.SetPrice(*v)
	}
	return _u
...
// SetOriginalPrice sets the "original_price" field.
func (_u *SubscriptionPlanUpdateOne) SetOriginalPrice(v decimal.Decimal) *SubscriptionPlanUpdateOne {
	_u.mutation.SetOriginalPrice(v)
	return _u
}

// SetNillableOriginalPrice sets the "original_price" field if the given value is not nil.
func (_u *SubscriptionPlanUpdateOne) SetNillableOriginalPrice(v *decimal.Decimal) *SubscriptionPlanUpdateOne {
	if v != nil {
		_u.SetOriginalPrice(*v)
	}
	return _u
...
// ClearProductName clears the value of the "product_name" field.
func (_u *SubscriptionPlanUpdateOne) ClearProductName() *SubscriptionPlanUpdateOne {
	_u.mutation.ClearProductName()
	return _u
}
...
// AddOrderIDs adds the "orders" edge to the PaymentOrder entity by IDs.
func (_u *SubscriptionPlanUpdateOne) AddOrderIDs(ids ...int64) *SubscriptionPlanUpdateOne {
	_u.mutation.AddOrderIDs(ids...)
	return _u
}

// AddOrders adds the "orders" edges to the PaymentOrder entity.
func (_u *SubscriptionPlanUpdateOne) AddOrders(v ...*PaymentOrder) *SubscriptionPlanUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearOrders clears all "orders" edges to the PaymentOrder entity.
func (_u *SubscriptionPlanUpdateOne) ClearOrders() *SubscriptionPlanUpdateOne {
	_u.mutation.ClearOrders()
	return _u
}

// RemoveOrderIDs removes the "orders" edge to PaymentOrder entities by IDs.
func (_u *SubscriptionPlanUpdateOne) RemoveOrderIDs(ids ...int64) *SubscriptionPlanUpdateOne {
	_u.mutation.RemoveOrderIDs(ids...)
	return _u
}

// RemoveOrders removes "orders" edges to PaymentOrder entities.
func (_u *SubscriptionPlanUpdateOne) RemoveOrders(v ...*PaymentOrder) *SubscriptionPlanUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
