...
func (_u *PaymentOrderUpdate) ClearUserEmail() *PaymentOrderUpdate {
...
func (_u *PaymentOrderUpdate) ClearUserName() *PaymentOrderUpdate {
...
func (_u *PaymentOrderUpdate) ClearPayAmount() *PaymentOrderUpdate {
	_u.mutation.ClearPayAmount()
	return _u
}
...
func (_u *PaymentOrderUpdate) ClearFeeRate() *PaymentOrderUpdate {
...
func (_u *PaymentOrderUpdate) ClearPaymentTradeNo() *PaymentOrderUpdate {
	_u.mutation.ClearPaymentTradeNo()
	return _u
}
...
func (_u *PaymentOrderUpdate) ClearRefundAmount() *PaymentOrderUpdate {
...
func (_u *PaymentOrderUpdate) SetRefundRequestedBy(v int64) *PaymentOrderUpdate {
	_u.mutation.ResetRefundRequestedBy()
...
func (_u *PaymentOrderUpdate) SetNillableRefundRequestedBy(v *int64) *PaymentOrderUpdate {
	if v != nil {
...
// AddRefundRequestedBy adds value to the "refund_requested_by" field.
func (_u *PaymentOrderUpdate) AddRefundRequestedBy(v int64) *PaymentOrderUpdate {
	_u.mutation.AddRefundRequestedBy(v)
	return _u
}
...
func (_u *PaymentOrderUpdate) ClearClientIP() *PaymentOrderUpdate {
...
func (_u *PaymentOrderUpdate) ClearSrcHost() *PaymentOrderUpdate {
	_u.mutation.ClearSrcHost()
	return _u
}
...
func (_u *PaymentOrderUpdate) SetPlan(v *SubscriptionPlan) *PaymentOrderUpdate {
	return _u.SetPlanID(v.ID)
}

// SetProviderInstance sets the "provider_instance" edge to the PaymentProviderInstance entity.
func (_u *PaymentOrderUpdate) SetProviderInstance(v *PaymentProviderInstance) *PaymentOrderUpdate {
	return _u.SetProviderInstanceID(v.ID)
}

// AddAuditLogIDs adds the "audit_logs" edge to the PaymentAuditLog entity by IDs.
func (_u *PaymentOrderUpdate) AddAuditLogIDs(ids ...int64) *PaymentOrderUpdate {
	_u.mutation.AddAuditLogIDs(ids...)
	return _u
}

// AddAuditLogs adds the "audit_logs" edges to the PaymentAuditLog entity.
func (_u *PaymentOrderUpdate) AddAuditLogs(v ...*PaymentAuditLog) *PaymentOrderUpdate {
...
func (_u *PaymentOrderUpdate) ClearProviderInstance() *PaymentOrderUpdate {
	_u.mutation.ClearProviderInstance()
	return _u
}

// ClearAuditLogs clears all "audit_logs" edges to the PaymentAuditLog entity.
func (_u *PaymentOrderUpdate) ClearAuditLogs() *PaymentOrderUpdate {
	_u.mutation.ClearAuditLogs()
	return _u
}

// RemoveAuditLogIDs removes the "audit_logs" edge to PaymentAuditLog entities by IDs.
func (_u *PaymentOrderUpdate) RemoveAuditLogIDs(ids ...int64) *PaymentOrderUpdate {
	_u.mutation.RemoveAuditLogIDs(ids...)
	return _u
}

// RemoveAuditLogs removes "audit_logs" edges to PaymentAuditLog entities.
func (_u *PaymentOrderUpdate) RemoveAuditLogs(v ...*PaymentAuditLog) *PaymentOrderUpdate {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
func (_u *PaymentOrderUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if _u.mutation.UserEmailCleared() {
		_spec.ClearField(paymentorder.FieldUserEmail, field.TypeString)
	}
	if value, ok := _u.mutation.UserName(); ok {
		_spec.SetField(paymentorder.FieldUserName, field.TypeString, value)
	}
	if _u.mutation.UserNameCleared() {
		_spec.ClearField(paymentorder.FieldUserName, field.TypeString)
	}
	...
	if _u.mutation.PayAmountCleared() {
		_spec.ClearField(paymentorder.FieldPayAmount, field.TypeOther)
	}
	...
	if _u.mutation.FeeRateCleared() {
		_spec.ClearField(paymentorder.FieldFeeRate, field.TypeOther)
	}
	...
	if _u.mutation.PaymentTradeNoCleared() {
		_spec.ClearField(paymentorder.FieldPaymentTradeNo, field.TypeString)
	}
	...
	if _u.mutation.RefundAmountCleared() {
		_spec.ClearField(paymentorder.FieldRefundAmount, field.TypeOther)
	}
	...
	if value, ok := _u.mutation.RefundRequestedBy(); ok {
		_spec.SetField(paymentorder.FieldRefundRequestedBy, field.TypeInt64, value)
	}
	if value, ok := _u.mutation.AddedRefundRequestedBy(); ok {
		_spec.AddField(paymentorder.FieldRefundRequestedBy, field.TypeInt64, value)
	}
	if _u.mutation.RefundRequestedByCleared() {
		_spec.ClearField(paymentorder.FieldRefundRequestedBy, field.TypeInt64)
	}
	...
	if _u.mutation.ClientIPCleared() {
		_spec.ClearField(paymentorder.FieldClientIP, field.TypeString)
	}
	if value, ok := _u.mutation.SrcHost(); ok {
		_spec.SetField(paymentorder.FieldSrcHost, field.TypeString, value)
	}
	if _u.mutation.SrcHostCleared() {
		_spec.ClearField(paymentorder.FieldSrcHost, field.TypeString)
	}
	...
	if _u.mutation.ProviderInstanceCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
	...
	if nodes := _u.mutation.ProviderInstanceIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   paymentorder.ProviderInstanceTable,
	...
	if _u.mutation.AuditLogsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   paymentorder.AuditLogsTable,
			Columns: []string{paymentorder.AuditLogsColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(paymentauditlog.FieldID, field.TypeInt64),
			},
		}
		_spec.Edges.Clear = append(_spec.Edges.Clear, edge)
	}
...
// ClearUserEmail clears the value of the "user_email" field.
func (_u *PaymentOrderUpdateOne) ClearUserEmail() *PaymentOrderUpdateOne {
	_u.mutation.ClearUserEmail()
	return _u
}
...
// ClearUserName clears the value of the "user_name" field.
func (_u *PaymentOrderUpdateOne) ClearUserName() *PaymentOrderUpdateOne {
	_u.mutation.ClearUserName()
	return _u
}
...
// ClearPayAmount clears the value of the "pay_amount" field.
func (_u *PaymentOrderUpdateOne) ClearPayAmount() *PaymentOrderUpdateOne {
	_u.mutation.ClearPayAmount()
	return _u
}
...
// ClearFeeRate clears the value of the "fee_rate" field.
func (_u *PaymentOrderUpdateOne) ClearFeeRate() *PaymentOrderUpdateOne {
	_u.mutation.ClearFeeRate()
	return _u
}
...
// ClearPaymentTradeNo clears the value of the "payment_trade_no" field.
func (_u *PaymentOrderUpdateOne) ClearPaymentTradeNo() *PaymentOrderUpdateOne {
	_u.mutation.ClearPaymentTradeNo()
	return _u
}
...
// ClearRefundAmount clears the value of the "refund_amount" field.
func (_u *PaymentOrderUpdateOne) ClearRefundAmount() *PaymentOrderUpdateOne {
	_u.mutation.ClearRefundAmount()
	return _u
}
...
// SetRefundRequestedBy sets the "refund_requested_by" field.
func (_u *PaymentOrderUpdateOne) SetRefundRequestedBy(v int64) *PaymentOrderUpdateOne {
	_u.mutation.ResetRefundRequestedBy()
	_u.mutation.SetRefundRequestedBy(v)
	return _u
}
...
// SetNillableRefundRequestedBy sets the "refund_requested_by" field if the given value is not nil.
func (_u *PaymentOrderUpdateOne) SetNillableRefundRequestedBy(v *int64) *PaymentOrderUpdateOne {
	if v != nil {
		_u.SetRefundRequestedBy(*v)
	}
	return _u
...
// AddRefundRequestedBy adds value to the "refund_requested_by" field.
func (_u *PaymentOrderUpdateOne) AddRefundRequestedBy(v int64) *PaymentOrderUpdateOne {
	_u.mutation.AddRefundRequestedBy(v)
	return _u
}
...
// ClearClientIP clears the value of the "client_ip" field.
func (_u *PaymentOrderUpdateOne) ClearClientIP() *PaymentOrderUpdateOne {
	_u.mutation.ClearClientIP()
	return _u
}
...
// ClearSrcHost clears the value of the "src_host" field.
func (_u *PaymentOrderUpdateOne) ClearSrcHost() *PaymentOrderUpdateOne {
	_u.mutation.ClearSrcHost()
	return _u
}
...
// SetPlan sets the "plan" edge to the SubscriptionPlan entity.
func (_u *PaymentOrderUpdateOne) SetPlan(v *SubscriptionPlan) *PaymentOrderUpdateOne {
	return _u.SetPlanID(v.ID)
}

// SetProviderInstance sets the "provider_instance" edge to the PaymentProviderInstance entity.
func (_u *PaymentOrderUpdateOne) SetProviderInstance(v *PaymentProviderInstance) *PaymentOrderUpdateOne {
	return _u.SetProviderInstanceID(v.ID)
}

// AddAuditLogIDs adds the "audit_logs" edge to the PaymentAuditLog entity by IDs.
func (_u *PaymentOrderUpdateOne) AddAuditLogIDs(ids ...int64) *PaymentOrderUpdateOne {
	_u.mutation.AddAuditLogIDs(ids...)
	return _u
}

// AddAuditLogs adds the "audit_logs" edges to the PaymentAuditLog entity.
func (_u *PaymentOrderUpdateOne) AddAuditLogs(v ...*PaymentAuditLog) *PaymentOrderUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
...
// ClearProviderInstance clears the "provider_instance" edge to the PaymentProviderInstance entity.
func (_u *PaymentOrderUpdateOne) ClearProviderInstance() *PaymentOrderUpdateOne {
	_u.mutation.ClearProviderInstance()
	return _u
}

// ClearAuditLogs clears all "audit_logs" edges to the PaymentAuditLog entity.
func (_u *PaymentOrderUpdateOne) ClearAuditLogs() *PaymentOrderUpdateOne {
	_u.mutation.ClearAuditLogs()
	return _u
}

// RemoveAuditLogIDs removes the "audit_logs" edge to PaymentAuditLog entities by IDs.
func (_u *PaymentOrderUpdateOne) RemoveAuditLogIDs(ids ...int64) *PaymentOrderUpdateOne {
	_u.mutation.RemoveAuditLogIDs(ids...)
	return _u
}

// RemoveAuditLogs removes "audit_logs" edges to PaymentAuditLog entities.
func (_u *PaymentOrderUpdateOne) RemoveAuditLogs(v ...*PaymentAuditLog) *PaymentOrderUpdateOne {
	ids := make([]int64, len(v))
	for i := range v {
		ids[i] = v[i].ID
	}
