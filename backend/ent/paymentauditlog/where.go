...
func DetailIsNil() predicate.PaymentAuditLog {
	return predicate.PaymentAuditLog(sql.FieldIsNull(FieldDetail))
}

// DetailNotNil applies the NotNil predicate on the "detail" field.
func DetailNotNil() predicate.PaymentAuditLog {
	return predicate.PaymentAuditLog(sql.FieldNotNull(FieldDetail))
}
...
func OperatorIsNil() predicate.PaymentAuditLog {
	return predicate.PaymentAuditLog(sql.FieldIsNull(FieldOperator))
}

// OperatorNotNil applies the NotNil predicate on the "operator" field.
func OperatorNotNil() predicate.PaymentAuditLog {
	return predicate.PaymentAuditLog(sql.FieldNotNull(FieldOperator))
}
...
func HasOrder() predicate.PaymentAuditLog {
	return predicate.PaymentAuditLog(func(s *sql.Selector) {
...
func HasOrderWith(preds ...predicate.PaymentOrder) predicate.PaymentAuditLog {
	return predicate.PaymentAuditLog(func(s *sql.Selector) {
		step := newOrderStep()
