...
type PaymentAuditLog struct {
	...
	// The values are being populated by the PaymentAuditLogQuery when eager-loading is set.
	Edges        PaymentAuditLogEdges `json:"edges"`
	selectValues sql.SelectValues
}

// PaymentAuditLogEdges holds the relations/edges for other nodes in the graph.
type PaymentAuditLogEdges struct {
...
func (e PaymentAuditLogEdges) OrderOrErr() (*PaymentOrder, error) {
	if e.Order != nil {
		return e.Order, nil
...
// QueryOrder queries the "order" edge of the PaymentAuditLog entity.
func (_m *PaymentAuditLog) QueryOrder() *PaymentOrderQuery {
	return NewPaymentAuditLogClient(_m.config).QueryOrder(_m)
}
