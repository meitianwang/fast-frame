...
func (e PaymentProviderInstanceEdges) OrdersOrErr() ([]*PaymentOrder, error) {
	if e.loadedTypes[0] {
		return e.Orders, nil
	}
...
// QueryOrders queries the "orders" edge of the PaymentProviderInstance entity.
func (_m *PaymentProviderInstance) QueryOrders() *PaymentOrderQuery {
	return NewPaymentProviderInstanceClient(_m.config).QueryOrders(_m)
}
